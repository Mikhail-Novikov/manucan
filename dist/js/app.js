...
var _partners = __webpack_require__(7);
...
var _carousel3 = __webpack_require__(11);
...
function imagesLayout(container, gutter) {
  ...
  for (var i = 0; i < images.length; i = i + size) {
    var sum = 0,
        sumGutter = 0,
        h = void 0;
    ...
    for (var _j = 0; _j < size; _j++) {
      images[i + _j] ? images[i + _j].style.height = h : null;
    }
  }
}

function addGalleryElements(event) {
  var actionElement = event.target.closest('[data-toggle="gallery"]');
  if (actionElement) {
...
/* harmony import */ var ssr_window__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17);
/**
 * Swiper 4.3.3
...
/* harmony import */ var ssr_window__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
/**
 * Dom7 2.0.7
